...
//Условие получения комманды с коротким форматом ответа
#define CMD_WITH_SHORT_RESPONSE(x)	(x==CMD_LINK_ECHO)||(x==CMD_LED_ON_OFF)||\
																		(x==CMD_STAMP_POL)||(x==CMD_STAMP_MODE_RANGE)||\
																		(x==CMD_STAMP_SET_OUT)||(x==CMD_ERR)
